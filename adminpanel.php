        ...
        <div>
            ...
            <form id="add-form" action="Business/add_person.php" method="POST">
                ...
                <div id="directors">
                    ...
                    <br />
                    <button class="stepper" id="btn_remove_dir" type="button" style="width:50px" onclick="stepDown('dir', 1)"> - </button>
                    <input class="stepper" name="dir" id="dir" style="width:50px"  value="0" step="1" >
                    <button class="stepper" id="btn_add_dir" type="button" style="width:50px" onclick="stepUp('dir', 1)"> + </button>
                    ...
                    <text>Writer(s)</text>
                    <br />
                    <button class="stepper" id="btn_remove_wrt" type="button" style="width:50px" onclick="stepDown('wrt', 1)"> - </button>
                    <input class="stepper" name="wrt"  id="wrt" style="width:50px"  value="0"  step="1" >
                    <button class="stepper" id="btn_add_wrt" type="button" style="width:50px" onclick="stepUp('wrt', 1)"> + </button>
                    ...
                    <br />
                    <button class="stepper" id="btn_remove_act" type="button" style="width:50px" onclick="stepDown('act', 1)"> - </button>
                    <input class="stepper" name="act"  id="act" style="width:50px"  value="0" step="1" >
                    <button class="stepper" id="btn_add_act" type="button" style="width:50px" onclick="stepUp('act', 1)"> + </button>
